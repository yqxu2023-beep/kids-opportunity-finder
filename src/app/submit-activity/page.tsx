...
export const metadata: Metadata = { title: "Submit an Activity | Kids Opportunity Finder", description: "Providers can submit a children's activity or youth program for review." };
