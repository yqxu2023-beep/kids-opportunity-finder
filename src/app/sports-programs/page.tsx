...
export const metadata: Metadata = { title: "Kids Sports Programs in Yellowknife | Kids Opportunity Finder", description: "Find youth sports programs, clubs, lessons, and beginner-friendly activities in Yellowknife." };
