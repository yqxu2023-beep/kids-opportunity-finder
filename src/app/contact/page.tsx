...
export const metadata: Metadata = { title: "Contact | Kids Opportunity Finder", description: "Contact Kids Opportunity Finder about listings, corrections, or partnerships." };
