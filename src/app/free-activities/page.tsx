...
export const metadata: Metadata = { title: "Free Kids Activities in Yellowknife | Kids Opportunity Finder", description: "Discover free activities, events, and programs for children and teens in Yellowknife." };
