...
export const metadata: Metadata = { title: "Teen Activities in Yellowknife | Kids Opportunity Finder", description: "Explore sports, arts, camps, and community programs for teens in Yellowknife." };
